...
public class SyncFurnace extends BlockContainer
{
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9){
    	...
    	par5EntityPlayer.openGui(SyncCraft.instance, 0, par1World, par2, par3, par4);
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlock(par2, par3, par4, SyncCraft.syncFurnaceBurning.blockID);
        }
        else
        {
            par1World.setBlock(par2, par3, par4, SyncCraft.syncFurnaceIdle.blockID);
        }
    ...
    {
        return new TileEntitySyncFurnace();
    }
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
    {
        ...
        {
            ((TileEntitySyncFurnace)par1World.getBlockTileEntity(par2, par3, par4)).setGuiDisplayName(par6ItemStack.getDisplayName());
        }
    }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        {
            TileEntitySyncFurnace tileentityfurnace = (TileEntitySyncFurnace)par1World.getBlockTileEntity(par2, par3, par4);
