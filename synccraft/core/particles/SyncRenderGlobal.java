...
public class SyncRenderGlobal implements IWorldAccess
{
    ...
    public SyncRenderGlobal(Minecraft par1Minecraft)
    {
  ...
  /*  /**
    ...
    public void spawnParticle(String par1Str, double par2, double par4, double par6, double par8, double par10, double par12)
    {
        ...
        catch (Throwable throwable)
        {
            ...
            crashreportcategory.addCrashSectionCallable("Position", new SyncCallableParticlePositionInfo(this, par2, par4, par6));
