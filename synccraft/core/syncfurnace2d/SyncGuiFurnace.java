...
{
    private static final ResourceLocation field_110410_t = new ResourceLocation("synccraft:textures/gui/container/furnace.png");
    ...
    {
        super(new SyncContainerFurnace(par1InventoryPlayer, par2TileEntityFurnace));
