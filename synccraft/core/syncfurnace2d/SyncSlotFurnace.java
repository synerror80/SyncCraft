...
public class SyncSlotFurnace extends Slot
{
    ...
    public SyncSlotFurnace(EntityPlayer par1EntityPlayer, IInventory par2IInventory, int par3, int par4, int par5)
    {
    ...
    protected void onCrafting(ItemStack par1ItemStack)
    {
        ...
        if (!this.thePlayer.worldObj.isRemote)
        {
            ...
            float f = SyncFurnaceRecipes.smelting().getExperience(par1ItemStack);
            int j;
