...
public class HumiteOre extends Block 
{
	public  HumiteOre(int id, Material material) 
	{
		...
		// func_111022_d("synccraft:humiteore64");
	}
	
	@SideOnly(Side.CLIENT)
    public void registerIcons(IconRegister ir)
    {
            this.blockIcon = ir.registerIcon("synccraft:humiteore64");
    }
	
	// this will drop an amount of an item randomly
	public int idDropped(int i, Random random, int fortune)
	{
		return SyncCraft.humite.itemID;
	}
